...
if 'logged_in' not in st.session_state or not st.session_state.logged_in:
    ...
    if st.session_state.page == "Lançamento Folha 📝" and st.session_state['role'] == 'user':
        ...
        with col_form:
            # Reestruturação para colocar tudo em um único formulário
        ...
        with col_view:
            ...
            # Usa o dataframe principal para garantir que os dados estão atualizados
            ...
            if not lancamentos_df.empty:
                ...
                # Converte 'Data' para datetime para ordenar corretamente
