...
if 'logged_in' not in st.session_state or not st.session_state.logged_in:
    ...
    if st.session_state.page == "Lançamento Folha 📝" and st.session_state['role'] == 'user':
        # ... O código desta página está completo mais abaixo ...
        pass
    ...
    # O restante das páginas
        ...
        elif st.session_state.page == "Gerenciar Obras":
        ...
        elif st.session_state.page == "Auditoria ✏️":
